...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_PVP_TOKEN_MAP_TYPE,
    CONFIG_UINT32_PVP_TOKEN_ID,
    CONFIG_UINT32_PVP_TOKEN_COUNT,
    CONFIG_UINT32_BG_ROTATE_HOURS,
    CONFIG_UINT32_ARENA_ANTIWINTRADE_WEEKDAY_START,
    CONFIG_UINT32_ARENA_ANTIWINTRADE_WEEKDAY_END,
    CONFIG_UINT32_ARENA_ANTIWINTRADE_WEEKEND_START,
    CONFIG_UINT32_ARENA_ANTIWINTRADE_WEEKEND_END,
    CONFIG_UINT32_SIGN_MINLEVEL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_DAMAGE_FALL_INSTANCE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_DUEL_RESTORE,
    CONFIG_BOOL_ARENA_ANTIWINTRADE,
...
class World
{
    public:
        ...
        void SendGMWorldText(AccountTypes security, int32 string_id, ...);
