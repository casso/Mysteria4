...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:
        ...
        inline bool Anti__CheatOccurred(uint32 CurTime,Player* Ply,const char* Reason,float Speed,const char* Op=NULL, float Val1=0.0f, uint32 Val2=0);
        bool Anti__ReportCheat(Player* Ply,const char* Reason,float Speed,const char* Op=NULL,float Val1=0.0f,uint32 Val2=0);
    ...
    public:                                                 // opcodes handlers
        ...
        void JoinIntoBattleground( ObjectGuid guid, uint32 bgTypeId_, uint32 instanceId, uint8 joinAsGroup );
