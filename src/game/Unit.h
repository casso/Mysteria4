...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        void RemovePositiveSpellsCausingAura(AuraType auraType, Aura* except);
        ...
        void CalcAbsorbResist(Unit *pVictim, SpellSchoolMask schoolMask, DamageEffectType damagetype, const uint32 damage, uint32 *absorb, uint32 *resist, bool canReflect = false, SpellEntry const *CastedSpellProto = NULL );
