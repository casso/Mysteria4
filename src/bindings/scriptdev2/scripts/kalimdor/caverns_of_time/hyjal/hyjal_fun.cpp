...
CreatureAI* GetAI_npc_jaina_proudmoore_fun(Creature* pCreature)
{
    hyjalAI_fun* pTempAI = new hyjalAI_fun(pCreature);
...
bool GossipHello_npc_jaina_proudmoore_fun(Player* pPlayer, Creature* pCreature)
{
    if (ScriptedInstance* pInstance = (ScriptedInstance*)pCreature->GetInstanceData())
    {
        if (hyjalAI_fun* pJainaAI = dynamic_cast<hyjalAI_fun*>(pCreature->AI()))
        {
...
bool GossipSelect_npc_jaina_proudmoore_fun(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    if (hyjalAI_fun* pJainaAI = dynamic_cast<hyjalAI_fun*>(pCreature->AI()))
    {
        switch(uiAction)
...
CreatureAI* GetAI_npc_thrall_fun(Creature* pCreature)
{
    hyjalAI_fun* pTempAI = new hyjalAI_fun(pCreature);
...
bool GossipHello_npc_thrall_fun(Player* pPlayer, Creature* pCreature)
{
    if (ScriptedInstance* pInstance = (ScriptedInstance*)pCreature->GetInstanceData())
    {
        if (hyjalAI_fun* pThrallAI = dynamic_cast<hyjalAI_fun*>(pCreature->AI()))
        {
...
bool GossipSelect_npc_thrall_fun(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    if (hyjalAI_fun* pThrallAI = dynamic_cast<hyjalAI_fun*>(pCreature->AI()))
    {
        switch(uiAction)
...
bool GossipHello_npc_tyrande_whisperwind_fun(Player* pPlayer, Creature* pCreature)
{
    if (ScriptedInstance* pInstance = (ScriptedInstance*)pCreature->GetInstanceData())
    {
...
bool GossipSelect_npc_tyrande_whisperwind_fun(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
...
void AddSC_hyjal_fun()
{
    Script *newscript;

    newscript = new Script;
    newscript->Name = "npc_jaina_proudmoore_fun";
    newscript->GetAI = &GetAI_npc_jaina_proudmoore_fun;
    newscript->pGossipHello = &GossipHello_npc_jaina_proudmoore_fun;
    newscript->pGossipSelect = &GossipSelect_npc_jaina_proudmoore_fun;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name = "npc_thrall_fun";
    newscript->GetAI = &GetAI_npc_thrall_fun;
    newscript->pGossipHello = &GossipHello_npc_thrall_fun;
    newscript->pGossipSelect = &GossipSelect_npc_thrall_fun;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name = "npc_tyrande_whisperwind_fun";
    newscript->pGossipHello = &GossipHello_npc_tyrande_whisperwind_fun;
    newscript->pGossipSelect = &GossipSelect_npc_tyrande_whisperwind_fun;
    newscript->RegisterSelf();
}
