...
bool GossipHello_barber(Player *player, Creature *_Creature)
{
    ...
    if (sitting)
    {
        ...
        if (player->HasItemCount(23580,1,false) && player->HasItemCount(10663,5,false))
            player->ADD_GOSSIP_ITEM(0, "Chcem zmenu! (1DT+5HT)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        else 
            player->ADD_GOSSIP_ITEM(0, "Prepac, nemas dostatok tokenov. (1DT+5HT)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
...
{
    char const* FeatureGossipMenu = "Chcem zmenit bradu.";
    switch (player->getRace())
    {
    case RACE_HUMAN:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit piercing.";
        break;
    case RACE_ORC:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit piercing.";
    ...
    case RACE_DWARF:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit nausnice.";
        break;
    case RACE_NIGHTELF:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit maskovanie.";
        break;
    case RACE_UNDEAD:
        FeatureGossipMenu = "Chcem zmenit tvar";
        break;
    case RACE_TAUREN:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit vlasy.";
        break;
    case RACE_GNOME:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit nausnice.";
        break;
    case RACE_TROLL:
        FeatureGossipMenu = "Chcem zmenit kly.";
        break;
    case RACE_BLOODELF:
        if (player->getGender() == GENDER_FEMALE)
            FeatureGossipMenu = "Chcem zmenit nausnice.";
        break;
    case RACE_DRAENEI:
        player->getGender() == GENDER_FEMALE ? FeatureGossipMenu = "Chcem zmenit rohy." : FeatureGossipMenu = "Chcem zmenit chapadla.";
        break;
    }
    // MAP
    // 1 - main menu
    ...
    case GOSSIP_ACTION_INFO_DEF+1:   
        ...
        player->ADD_GOSSIP_ITEM(0, "Chcem zmenit uces.", GOSSIP_SENDER_OPTION , GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, "Chcem zmenit farbu vlasov.", GOSSIP_SENDER_OPTION , GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, FeatureGossipMenu, GOSSIP_SENDER_OPTION , GOSSIP_ACTION_INFO_DEF + 6);
        player->SEND_GOSSIP_MENU(60023, _Creature->GetGUID());
        break;
        // hair style
    ...
    case GOSSIP_ACTION_INFO_DEF+3:
        ...
        player->ADD_GOSSIP_ITEM(0, "Dalsie!", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(0, "Predchadzajuce!", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(0, "Tieto chcem.", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 1);
    ...
    case GOSSIP_ACTION_INFO_DEF+5:
        if (action == GOSSIP_ACTION_INFO_DEF+5 && sender == GOSSIP_SENDER_SUBOPTION)
            SelectHairColor(player,-1);
        // choose options again
        player->ADD_GOSSIP_ITEM(0, "Dalsie!", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 4);
        player->ADD_GOSSIP_ITEM(0, "Predchadzajuce!",GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(0, "Tieto chcem.", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 1);
        player->SEND_GOSSIP_MENU(60024, _Creature->GetGUID());
        break;
    ...
    case GOSSIP_ACTION_INFO_DEF+7:
        if (action == GOSSIP_ACTION_INFO_DEF+7 && sender == GOSSIP_SENDER_SUBOPTION)
            SelectFacialFeature(player,-1);
        // choose options again
        player->ADD_GOSSIP_ITEM(0, "Dalsie!", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(0, "Predchadzajuce!", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(0, "Tieto chcem.", GOSSIP_SENDER_SUBOPTION , GOSSIP_ACTION_INFO_DEF + 1);
        player->SEND_GOSSIP_MENU(60024, _Creature->GetGUID());
        break;
